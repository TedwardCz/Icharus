...
namespace Icharus
{
    public class Program
    {
        ...
        {
            Console.WriteLine("Icharus CRM Lead Qualification Tool");
            Console.WriteLine("==============================");
            ...
            Console.WriteLine($"Qualifying lead with ID: {leadGuid.Value}");
            ...
            try
            {
                ...
                Console.WriteLine($"Lead qualified successfully with result ID: {resultId} (copied to clipboard)");
            }
            catch (Exception clipboardEx)
            {
                Console.WriteLine($"Lead qualified successfully with result ID: {resultId}");
        ...
        private static void LoadEnvironmentConfiguration(string environment)
        {
            ...
            LeadTeamId = ConfigurationManager.AppSettings["LenderLeadAdmin"] ?? string.Empty;
        ...
        private static bool ValidateConfigSettings()
        {
            ...
            {
                Console.WriteLine("Error: _vuhlLeadAdmin (Lead Team ID) is not configured.");
                isValid = false;
            }
        ...
        /// <summary>
        /// Qualifies a lead in CRM using the CRM SDK or mock implementation
        /// </summary>
        ...
        public static Guid QualifyCrmLead(Guid leadId)
        {
            ...
            Console.WriteLine($"Qualifying lead with ID: {leadId}");
            ...
            if (UseMockImplementation)
            {
                ...
                Console.WriteLine("Mock lead qualification for lead ID: " + leadId);
                Console.WriteLine("Lead would be qualified to an opportunity and contact in a real implementation");
                
                // Generate a random GUID for the result ID (simulating an opportunity ID)
                Guid resultId = Guid.NewGuid();
                Console.WriteLine($"Mock lead qualified with result ID: {resultId}");
            ...
            else
            {
                try
                {
                    ...
                    Console.WriteLine($"Retrieving lead with ID: {leadId}");
                    ...
                    if (lead == null)
                    {
                        throw new Exception($"Lead with ID {leadId} not found in CRM");
                    }
                    
                    Console.WriteLine("Lead found. Setting up qualification...");
                    ...
                    try
                    {
                        ...
                        Console.WriteLine("Executing lead qualification request...");
                            ...
                            response.Results["CreatedEntities"] is Crm.CoreService.NuGet.Standard.Models.EntityReferenceCollection createdEntities)
                        {
                            ...
                            foreach (var entityRef in createdEntities)
                            {
                                ...
                                {
                                    Console.WriteLine($"Lead qualified successfully. Created opportunity with ID: {entityRef.Id}");
                                    return entityRef.Id;
                                }
                            }
                        }
                        ...
                        Console.WriteLine("Lead qualified successfully, but couldn't retrieve opportunity ID.");
                        return leadId;
                    }
                    catch (Exception ex)
                    {
                        Console.WriteLine($"Error during lead qualification: {ex.Message}");
                        throw;
                    }
#else
                ...
                {
                    Console.WriteLine("Error qualifying lead in CRM: {0}", ex.Message);
                    throw new Exception("Failed to qualify lead in CRM", ex);
                }
            }
        }
        
        /// <summary>
        /// Sets up test data for CRM lead qualification
        /// </summary>
        public static void SetupCrmRegularLeadTestData()
        {
            ...
            for (int i = 1; i <= 5; i++)
            {
                ...
                Console.WriteLine($"Qualified test lead {i} with ID: {testLeadId}, result ID: {resultId}");
            }
        }
    }
}
