# CreateRealtyOpp.ps1
# This script executes CreateRealtyLead and QualifyRealtyLead in sequence
# It captures the lead ID from CreateRealtyLead and passes it to QualifyRealtyLead
...
Write-Host "========================================"
Write-Host "CreateRealtyOpp Script"
...
Write-Host "`n========================================"
Write-Host "CreateRealtyOpp Script Completed"
Write-Host "========================================"
